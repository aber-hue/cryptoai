...
--> statement-breakpoint
CREATE INDEX `idx_signal_event_actions_event_id` ON `signalEventActions` (`signalEventId`);--> statement-breakpoint
CREATE INDEX `idx_signal_event_actions_created_at` ON `signalEventActions` (`createdAt`);--> statement-breakpoint
CREATE INDEX `idx_signal_event_metrics_event_id` ON `signalEventMetrics` (`signalEventId`);--> statement-breakpoint
CREATE INDEX `idx_signal_event_metrics_metric_key` ON `signalEventMetrics` (`metricKey`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_symbol` ON `signalEvents` (`symbol`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_token_id` ON `signalEvents` (`tokenId`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_signal_type` ON `signalEvents` (`signalType`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_status` ON `signalEvents` (`status`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_triggered_at` ON `signalEvents` (`triggeredAt`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_status_triggered_at` ON `signalEvents` (`status`,`triggeredAt`);--> statement-breakpoint
CREATE INDEX `idx_signal_events_type_triggered_at` ON `signalEvents` (`signalType`,`triggeredAt`);--> statement-breakpoint
CREATE INDEX `idx_signal_templates_category` ON `signalTemplates` (`category`);--> statement-breakpoint
